                ...
                case "ObjectsTD":
                    {
                        if (Value == true)
                        {
                            if (NameSpace.OpenSubKey("{0DB7E03F-FC29-4DC6-9020-FF41B59E513A}", true) == null)
                                NameSpace.CreateSubKey("{0DB7E03F-FC29-4DC6-9020-FF41B59E513A}", true);
                        }
                        else if (Value == false)
                        {
                            if (NameSpace.OpenSubKey("{0DB7E03F-FC29-4DC6-9020-FF41B59E513A}", true) != null)
                ...
                case "Desktop":
                    {
                        if (Value == true)
                        {
                            if (NameSpace.OpenSubKey("{B4BFCC3A-DB2C-424C-B029-7FE99A87C641}", true) == null)
                                NameSpace.CreateSubKey("{B4BFCC3A-DB2C-424C-B029-7FE99A87C641}", true);
                        }
                        else if (Value == false)
                        {
                            if (NameSpace.OpenSubKey("{B4BFCC3A-DB2C-424C-B029-7FE99A87C641}", true) != null)
                ...
                case "Documents":
                    {
                        if (Value == true)
                        {
                            if (NameSpace.OpenSubKey("{A8CDFF1C-4878-43be-B5FD-F8091C1C60D0}", true) == null)
                                NameSpace.CreateSubKey("{A8CDFF1C-4878-43be-B5FD-F8091C1C60D0}", true);
                            if (NameSpace.OpenSubKey("{d3162b92-9365-467a-956b-92703aca08af}", true) == null)
                                NameSpace.CreateSubKey("{d3162b92-9365-467a-956b-92703aca08af}", true);
                        }
                        else if (Value == false)
                        {
                            if (NameSpace.OpenSubKey("{A8CDFF1C-4878-43be-B5FD-F8091C1C60D0}", true) != null)
                ...
                case "Downloads":
                    {
                        if (Value == true)
                        {
                            if (NameSpace.OpenSubKey("{374DE290-123F-4565-9164-39C4925E467B}", true) == null)
                                NameSpace.CreateSubKey("{374DE290-123F-4565-9164-39C4925E467B}", true);
                            if (NameSpace.OpenSubKey("{088e3905-0323-4b02-9826-5d99428e115f}", true) == null)
                                NameSpace.CreateSubKey("{088e3905-0323-4b02-9826-5d99428e115f}", true);
                        }
                        else if (Value == false)
                        {
                            if (NameSpace.OpenSubKey("{374DE290-123F-4565-9164-39C4925E467B}", true) != null)
                ...
                case "Pictures":
                    {
                        if (Value == true)
                        {
                            if (NameSpace.OpenSubKey("{3ADD1653-EB32-4cb0-BBD7-DFA0ABB5ACCA}", true) == null)
                                NameSpace.CreateSubKey("{3ADD1653-EB32-4cb0-BBD7-DFA0ABB5ACCA}", true);
                            if (NameSpace.OpenSubKey("{24ad3ad4-a569-4530-98e1-ab02f9417aa8}", true) == null)
                                NameSpace.CreateSubKey("{24ad3ad4-a569-4530-98e1-ab02f9417aa8}", true);
                        }
                        else if (Value == false)
                        {
                            if (NameSpace.OpenSubKey("{3ADD1653-EB32-4cb0-BBD7-DFA0ABB5ACCA}", true) != null)
                ...
                case "Music":
                    {
                        if (Value == true)
                        {
                            if (NameSpace.OpenSubKey("{1CF1260C-4DD0-4ebb-811F-33C572699FDE}", true) == null)
                                NameSpace.CreateSubKey("{1CF1260C-4DD0-4ebb-811F-33C572699FDE}", true);
                            if (NameSpace.OpenSubKey("{3dfdf296-dbec-4fb4-81d1-6a3438bcf4de}", true) == null)
                                NameSpace.CreateSubKey("{3dfdf296-dbec-4fb4-81d1-6a3438bcf4de}", true);
                        }
                        else if (Value == false)
                        {
                            if (NameSpace.OpenSubKey("{1CF1260C-4DD0-4ebb-811F-33C572699FDE}", true) != null)
                ...
                case "Videos":
                    {
                        if (Value == true)
                        {
                            if (NameSpace.OpenSubKey("{A0953C92-50DC-43bf-BE83-3742FED03C9C}", true) == null)
                                NameSpace.CreateSubKey("{A0953C92-50DC-43bf-BE83-3742FED03C9C}", true);
                            if (NameSpace.OpenSubKey("{f86fa3ab-70d2-4fc7-9c99-fcbf05467f3a}", true) == null)
                                NameSpace.CreateSubKey("{f86fa3ab-70d2-4fc7-9c99-fcbf05467f3a}", true);
                        }
                        else if (Value == false)
                        {
                            if (NameSpace.OpenSubKey("{A0953C92-50DC-43bf-BE83-3742FED03C9C}", true) != null)
